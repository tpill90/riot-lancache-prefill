namespace RiotPrefill.ReleaseManifestFile
{
    /// <summary>
    /// TODO
    /// This was taken verbatim from LeagueToolkit (https://github.com/LeagueToolkit/LeagueToolkit).
    /// The reason for copying this is to dramatically improve the performance of manifest parsing, from nearly 2 seconds down to ~300ms.
    ///
